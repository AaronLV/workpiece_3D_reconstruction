...
* The robot in the lab is UR v3.x. So we need to install UR modern driver from: https://github.com/ThomasTimm/ur_modern_driver  To bring up the real robot, run the following command after replacing IP_OF_THE_ROBOT with the actual hardware's address:
```
